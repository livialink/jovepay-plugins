...
namespace JP\JovePay\Controller\Payment;
...
class Redirect extends \Magento\Framework\App\Action\Action
{
     ...
     * @param \JP\JovePay\Helper\Data $jovePayHelper
     */
    public function __construct(
        ...
        \JP\JovePay\Helper\Data $jovePayHelper
    ) {
    ...
    public function execute()
    {
        ...
        $orderModel->setState(Order::STATE_NEW)
            ->setStatus($this->jovePayHelper->getGeneralConfig('status_order_placed'));
