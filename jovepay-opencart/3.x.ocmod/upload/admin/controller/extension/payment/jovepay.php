...
class ControllerExtensionPaymentJovepay extends Controller
{
	...
	public function index()
	{
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/jovepay', 'user_token=' . $this->session->data['user_token'], true)
		);

		$data['action'] = $this->url->link('extension/payment/jovepay', 'user_token=' . $this->session->data['user_token'], true);
		...
		$this->response->setOutput($this->load->view('extension/payment/jovepay', $data));
	}

	private function validate()
	{
		if (!$this->user->hasPermission('modify', 'extension/payment/jovepay')) {
